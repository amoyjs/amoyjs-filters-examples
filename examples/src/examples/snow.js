...
import {AmoySnowFilter} from '@amoy/filters';

export default class SnowExample {
    ...
    constructor(app){
        ...
        let pic = PIXI.Sprite.from(app.resources.snow.texture);
        pageContainer.addChild(pic);
        
        scene.addChild(pageContainer);
    
        let filter = new AmoySnowFilter(false, 0);
